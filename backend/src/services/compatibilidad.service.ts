...
/**
 * Tipos que no aportan consumo ni participan en validaciones
 * eléctricas/dimensionales del equipo (PSU provee, gabinete aloja,
 * y los periféricos son externos).
 */
const TIPOS_EXCLUIDOS_CONSUMO = new Set<string>([
    'PSU',
    'GABINETE',
    ...TIPOS_PERIFERICOS,
]);
...
export class CompatibilidadService {
    ...
    static validarConsumo(
        ...
        for (const comp of componentes) {
            if (TIPOS_EXCLUIDOS_CONSUMO.has(comp.tipo)) continue;
