...
export class ProductoService {
    ...
    /**
     * Lista TODOS los componentes de un tipo (no solo 10) filtrando por
     * compatibilidad con los componentes ya seleccionados por el usuario.
     * Usado por el configurador paso a paso para no mostrar incompatibles.
     */
    static async listarCompatibles(
        tipo: string,
        componenteIdsActuales: string[],
        ...
        // Si no hay otros componentes seleccionados, no hay nada que filtrar
        if (componentesActuales.length === 0) return candidatos;
